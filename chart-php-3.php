<?php
 $data = array(
    array("name" => "ส่วนกลาง", "y" => 6141, "drilldown" => "a"), 
    array("name" => "ภาคเหนือ", "y" => 1184, "drilldown" => "b"), 
    array("name" => "ภาคกลาง", "y" => 1085, "drilldown" => "c"), 
    array("name" => "ภาคตะวันออกเฉียงเหนือ", "y" => 467, "drilldown" => "d"), 
    array("name" => "ภาคตะวันออก", "y" => 418, "drilldown" => "e"), 
    array("name" => "ภาคใต้", "y" => 164, "drilldown" => "f"), 
    array("name" => "ชายแดนภาคใต้","y" => 120, "drilldown" => "g")
);  
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            Highcharts.chart('map', {
                ...
                drilldown: {
                    series: <?php echo json_encode($data_drilldown); ?>
                }
            });
        });
    </script>
